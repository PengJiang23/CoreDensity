...
(function (a, b) {
    ...
    function l(a, c, d) {
        if (d === b && a.nodeType === 1) {
            var e = "raw_data-" + c.replace(k, "-$1").toLowerCase();
            d = a.getAttribute(e);
            if (typeof d == "string") {
                try {
            ...
            if (a === b) {
                if (this.length) {
                    ...
                    if (j.nodeType === 1 && !f._data(j, "parsedAttrs")) {
                        g = j.attributes;
                        for (i = g.length; k < i; k++) h = g[k].name, h.indexOf("raw_data-") === 0 && (h = f.camelCase(h.substring(5)), l(j, h, m[h]));
    ...
    var V = "abbr|article|aside|audio|bdi|canvas|raw_data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
